...
;(function(DocsAPI, window, document, undefined) {
    ...
    */
        ...
        var _checkConfigParams = function() {
            if (_config.document) {
                ...
                if (typeof _config.document.fileType === 'string' && _config.document.fileType != '') {
                    ...
                    var type = /^(?:(xls|xlsx|ods|csv|tsv|gsheet|xlsm|xlt|xltm|xltx|fods|ots|xlsb|sxc|et|ett|numbers)|(pps|ppsx|ppt|pptx|odp|gslides|pot|potm|potx|ppsm|pptm|fodp|otp|sxi|dps|dpt|key|odg)|(pdf|djvu|xps|oxps)|(doc|docx|odt|gdoc|txt|rtf|mht|htm|html|mhtml|epub|docm|dot|dotm|dotx|fodt|ott|fb2|xml|oform|docxf|sxw|stw|wps|wpt|pages|hwp|hwpx|md|hml))$/
    ...
    function getAppPath(config) {
        ...
        if (config.document) {
            if (typeof config.document.fileType === 'string')
                type = /^(?:(pdf)|(djvu|xps|oxps)|(xls|xlsx|ods|csv|tsv|xlst|xlsy|gsheet|xlsm|xlt|xltm|xltx|fods|ots|xlsb|numbers)|(pps|ppsx|ppt|pptx|odp|pptt|ppty|gslides|pot|potm|potx|ppsm|pptm|fodp|otp|key|odg)|(oform|docxf))$/
        ...
        if (config.editorConfig && path_type!=="forms" && appType!=='common') {
            ...
            } else if (config.editorConfig.mode === 'editmerge' || config.editorConfig.mode === 'editole')
    ...
    function getAppParameters(config) {
        ...
        if (config.editorConfig && (config.editorConfig.mode == 'editmerge' || config.editorConfig.mode == 'editole'))
