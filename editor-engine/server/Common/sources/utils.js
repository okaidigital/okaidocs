...
function changeOkaiDocsUrl(inputUrl, strPath, optFilename) {
  //okaidocs file server expects url end with file extension
...
exports.changeOkaiDocsUrl = changeOkaiDocsUrl;
/**
...
exports.isLiveViewerSupport = function (_licenseInfo) {
  return true;
};
